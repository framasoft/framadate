...
<div class="row">
    <div class="col-md-12">
        <form action="" method="POST">
            ...
            <fieldset>
                <legend>{t('Installation', 'General')}</legend>
                <div class="form-group">
                    <div class="form-group">
                        <div class="input-group">
                            <label for="appName" class="input-group-addon">* {t('Installation', 'Application name')}</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="input-group">
                                    <label for="appMail" class="input-group-addon">* {t('Installation', 'Administrator mail address')}</label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="input-group">
                                    <label for="responseMail" class="input-group-addon">{t('Installation', 'Respond-to mail address')}</label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="input-group">
                                    <label for="defaultLanguage" class="input-group-addon">* {t('Installation', 'Default language')}</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <label for="cleanUrl" class="input-group-addon">{t('Installation', 'Clean URL')}</label>
            ...
            <fieldset>
                <legend>{t('Installation', 'Database name')}</legend>

                <div class="form-group">
                    {t('Installation', 'Database driver')}
                    <div class="radio">
                        <label>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="form-group">
                            <div class="input-group">
                                <label for="dbHost" class="input-group-addon">{t('Installation', 'Database hostname')}</label>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="input-group">
                                <label for="dbPort" class="input-group-addon">{t('Installation', 'Database port')}</label>
                ...
                <div class="form-group">
                    <div class="input-group">
                        <label for="dbName" class="input-group-addon">{t('Installation', 'Database name')}</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                <label for="dbUser" class="input-group-addon">* {t('Installation', 'User')}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                <label for="dbPassword" class="input-group-addon">{t('Installation', 'Password')}</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                <label for="dbPrefix" class="input-group-addon">{t('Installation', 'Prefix')}</label>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <div class="input-group">
                                <label for="migrationTable" class="input-group-addon">* {t('Installation', 'Migration table')}</label>
            ...
            <div class="text-center form-group">
                <button type="submit" class="btn btn-primary">{t('Installation', 'Install')}</button>
            </div>
