        ...
        <div class="checkbox">
            <label>
                <input type="checkbox" name="use_password" {if $poll_use_password}checked{/if}
                       id="use_password">
                {t('Step 1', "Use a password to restrict access")}
            </label>
        </div>
    </div>
        ...
        <div class="col-sm-offset-4 col-sm-8">
            <div class="input-group">
                ...
                <label for="poll_password"
                       class="input-group-addon">{t('Step 1', 'Choice')}</label>
            </div>
        </div>
        ...
        <div class="col-sm-offset-4 col-sm-8">
            <div class="input-group">
                ...
                <label for="poll_password_repeat"
                       class="input-group-addon">{t('Step 1', 'Confirmation')}</label>
            </div>
        </div>
        ...
        <div class="col-sm-offset-4 col-sm-8">
            <div class="checkbox">
                <label>
                    ...
                    {t('Step 1', "The results are publicly visible")}
                </label>
            </div>
        </div>
    </div>
