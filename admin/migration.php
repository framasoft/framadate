...
use Framadate\Migration\AddColumn_admin_choice_exp_In_poll;
use Framadate\Migration\AddColumn_admin_choice_In_poll;
...
$migrations = [
    ...
    new AddColumn_admin_choice_In_poll(),
    new AddColumn_admin_choice_exp_In_poll(),
];
// ---------------------------------------
