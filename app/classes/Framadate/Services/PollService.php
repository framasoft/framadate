...
class PollService {
     ...
     */
    function doPollCreation(Form $form, int $input_type) {
        // Define expiration date
        $enddate = filter_input($input_type, 'enddate', FILTER_VALIDATE_REGEXP, ['options' => ['regexp' => '#^[0-9]{2}/[0-9]{2}/[0-9]{4}$#']]);
