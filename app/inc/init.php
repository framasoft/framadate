...
if (getenv('APP_ENV') === 'test') {
    ...
    define('FRAMADATE_DB_DRIVER', getenv('FRAMADATE_DB_DRIVER') || 'pdo_sqlite');
    define('FRAMADATE_DB_NAME', getenv('FRAMADATE_DB_NAME') || 'framadate');
    define('FRAMADATE_DB_HOST', getenv('FRAMADATE_DB_HOST') || '');
    define('FRAMADATE_DB_PORT', getenv('FRAMADATE_DB_PORT') || '');
    define('FRAMADATE_DB_USER', getenv('FRAMADATE_DB_USER') || '');
    define('FRAMADATE_DB_PASSWORD', getenv('FRAMADATE_DB_PASSWORD') ||'');
}
